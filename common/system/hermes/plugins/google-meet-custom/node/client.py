...
class NodeClient:
    ...
    def start_bot(
        ...
        payload: Dict[str, Any] = {
            ...
            "mode": mode,
            "language": language,
            "translated_captions": bool(translated_captions),
        }
        if duration is not None:
            payload["duration"] = duration
        if translation_target is not None:
            payload["translation_target"] = translation_target
    ...
    def set_language(self, language: str, translated_captions: bool = False, translation_target: Optional[str] = None) -> Dict[str, Any]:
        return self._rpc("set_language", {
            "language": language,
            "translated_captions": bool(translated_captions),
