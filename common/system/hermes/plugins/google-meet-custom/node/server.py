...
custom plugin's ``process_manager`` module.
    ...
    async def _handle_request(self, msg: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if t == "start_bot":
                ...
                kwargs = {
                    k: payload[k]
                    for k in ("url", "guest_name", "duration", "headed", "mode",
                               "language", "translated_captions", "translation_target",
            ...
            if t == "set_language":
                result = pm.set_language(
                    language=payload.get("language", "es-MX"),
                    translated_captions=bool(payload.get("translated_captions")),
